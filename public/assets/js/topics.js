export const topics = {
  ...
  cantantes: [
    "Bad Bunny","Daddy Yankee","Don Omar","Wisin","Yandel","Rauw Alejandro","Ozuna","Anuel AA",
    "Tego Calderón","Residente","Luis Fonsi","Ricky Martin","Chayanne","Pedro Capó","Nicky Jam","Farruko","De La Ghetto","Ñengo Flow","Arcángel","Zion","Lennox","Plan b",
  ...
  "Fútbol": {
    ...
    "🇦🇷 Liga Argentina (actuales)": [
      ...
      "Iker Muniain",
      // Rosario Central
      "Ángel Di María","Ignacio Malcorra","Jorge Broun",
      // Talleres
      "Federico Girotti"
    ],
    ...
    "🏟️ Equipos" : [
      ...
      "Atlético Nacional","Millonarios FC","América de Cali","Junior FC",
